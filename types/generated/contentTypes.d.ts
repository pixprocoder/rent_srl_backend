...
export interface ApiBookingBooking extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ReturnDate: Attribute.DateTime & Attribute.Required;
    Category: Attribute.Enumeration<['Scooter', 'Car']> &
      Attribute.Required &
      Attribute.DefaultTo<'Car'>;
...
export interface ApiCarCar extends Schema.CollectionType {
  ...
  attributes: {
    ...
    FuelType: Attribute.String & Attribute.Required;
